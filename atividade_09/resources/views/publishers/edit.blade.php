...
<div class="container">
    ...
    <form action="{{ route('publishers.update', $publisher) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('foundation_date') is-invalid @enderror" id="foundation_date" name="foundation_date" value="{{ old('foundation_date', $publisher->foundation_date) }}">
