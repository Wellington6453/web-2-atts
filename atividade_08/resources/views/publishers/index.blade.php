...
<div class="container">
    ...
    {{-- Criar editora — apenas admin e bibliotecário --}}
        ...
        <tbody>
            @forelse($publishers as $publisher)
                <tr>
                    ...
                    <td>
                        {{ $publisher->foundation_date
                            ? \Carbon\Carbon::parse($publisher->foundation_date)->format('d/m/Y')
                            : '-' }}
                    </td>
                    <td>
